...
// Verifica o acesso do usuário com função específica (no caso, 'admin')
checkAccess('admin');
?>
...
<head>
    ...
    <style>
        ...
        .card {
            flex: 1 1 100%; /* Flex-grow, flex-shrink, and flex-basis for responsiveness */
        }

        /* Ajustes para diferentes tamanhos de tela */
        @media (min-width: 576px) {
            .card {
                flex: 1 1 calc(50% - 1rem); /* Flex-grow, flex-shrink, and flex-basis with margin adjustment */
            }
        }

        @media (min-width: 768px) {
            .card {
                flex: 1 1 calc(33.333% - 1rem); /* Flex-grow, flex-shrink, and flex-basis with margin adjustment */
            }
        }

        @media (min-width: 992px) {
            .card {
                flex: 1 1 calc(25% - 1rem); /* Flex-grow, flex-shrink, and flex-basis with margin adjustment */
            }
        }

        /* Garantir espaçamento uniforme */
        .row {
            display: flex;
            flex-wrap: wrap;
...
<body>
    ...
    <div id="linha" class="container py-5">
        <div id="linha" class="row ms-auto me-auto">
            <div class="col">
            ...
            <div class="col">
                <div class="card h-100">
                    <img src="imagens/add-user-3.png" alt="Ícone usuário com símbolo de adição" class="card-img-top">
                    <h5 class="card-header">Gerenciar Usuários</h5>
                    <div class="card-body centralizar-botao">
                        <a href="usuario.php"><button class="btn btn-primary btn-custom">Acessar</button></a>
                    </div>
                </div>
            </div>
        </div>
